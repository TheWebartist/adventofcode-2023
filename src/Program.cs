...
List<IPuzzleSolver> solvedPuzzles = [new Day01PuzzleSolver(), new Day02PuzzleSolver(), new Day03PuzzleSolver(), new Day04PuzzleSolver(), new Day05PuzzleSolver(), new Day06PuzzleSolver()];
